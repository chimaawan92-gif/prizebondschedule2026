...
<body>
  ...
  <main class="container">
    ...
    <article>
      ...
      <p class="intro">
        Checking a prize bond number is a simple way to find out whether a particular
        bond number appears in an official draw result. You normally need your bond
      ...
      <ol>
        ...
        <li>Selecting the correct draw.</li>
        <li>Searching the published result.</li>
        <li>Comparing the complete number.</li>
        <li>Verifying the information with a reliable source.</li>
      </ol>
